...
<html lang="en">
  ...
  <body>
    ...
    <ul>
        ...
        <li>
            <a href="view.php"><strong>View</strong></a> - View all users
        </li>
        <li>
            <a href="update.php"><strong>Update</strong></a> - update users
        </li>
        <li>
            <a href="delete.php"><strong>Delete</strong></a> - delete users
        </li>
        <li>
